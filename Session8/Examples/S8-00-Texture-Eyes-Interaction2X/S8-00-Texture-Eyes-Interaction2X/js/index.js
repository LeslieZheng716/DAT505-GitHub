...
function render() {
	...
	for (var i = 0; i < eyesNum; i++) {
		...
		/*if (mouseX<140) eyes[2].rotation.y = map_range(mouseX, 0, 140, -1.14, 0.25);
		else eyes[2].rotation.y = map_range(mouseX, 140, window.innerWidth, 0.25, 1.14);
		if (mouseY<35) eyes[2].rotation.x = map_range(mouseY, 0, 60, -1.14, 0.25);
		else eyes[2].rotation.x = map_range(mouseY, 35, window.innerHeight, 0.25, 1.14);
		...
		if (mouseY<35) eyes[3].rotation.x = map_range(mouseY, 0, 550, -0.2, 0.25);
